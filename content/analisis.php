    ...
    <div class="card">
        <div class="card-body py-3 px-4">
            <form method="GET" action="index.php" class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div style="width:200px;"> <select name="tahun" class="form-select" onchange="this.form.submit()"> <!-- OPTION ALL -->
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($queryRank)) :
                                ...
                                /* warna progress */
                                if ($persen <= 20) $warna = "bg-danger";
                                elseif ($persen <= 40) $warna = "bg-warning";
                                elseif ($persen <= 60) $warna = "bg-info";
                                elseif ($persen <= 80) $warna = "bg-primary";
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <div class="d-flex align-items-center mb-4 flex-wrap">
                            ...
                            <span
                                ...
                                id="tanamanIconi"
                                style="font-size:30px;width:42px;height:42px;">
                            </span>

                            <p class="text-success fw-bold me-2 mb-0"
                                id="tanamanValue"
                                style="font-size:36px;">
                                0%
                            </p>

                            <p class="fs-5 text-muted mb-0">Tingkat Hidup</p>
...
<script>document.addEventListener("DOMContentLoaded", function () {
  ...
  var options = {
    series: [
      { name: "Target Pohon", data: targetData },
      { name: "Realisasi Tanam", data: realisasiData }
    ],
    chart: {
      type: "bar",
      height: 480
