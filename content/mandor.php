    ...
    <div class="card-body">
      <div class="d-flex align-items-center justify-content-between mb-1">
        <div>
          ...
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#formmandorModal">
            <iconify-icon icon="solar:add-square-bold" height="25" style="vertical-align: -0.5em;"></iconify-icon> Tambah
          </button> <?php }?>
          <h5 class="card-title fw-semibold mt-3">Data mandor</h5>
        </div>
          <?php if ($_SESSION['role'] == 'admin') { ?>
        <a href="../laporan/export_data_mandor.php" target="_blank" class="btn btn-success">
      ...
      <!-- Modal Tambah mandor -->
      <div class="modal fade" id="formmandorModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h5 class="modal-title text-white">Tambah mandor</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
              <form action="../function/fungsi_mandor.php?aksi=simpan" method="POST" enctype="multipart/form-data">
                <div class="row mb-3">
                  <div>
                    <h4>Data Diri</h4>
                    <hr>
                  ...
                  <div class="col align-self-center">
                    ...
                    <div class="form-text">Maksimal ukuran file 2MB. Format file: .JPG, .JPEG, .PNG</div>
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3">
                    <label for="nip">NIP</label>
                    <input type="text" id="nip" class="form-control" placeholder="Masukkan nip" name="nip" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea id="alamat" class="form-control" placeholder="Masukkan Alamat Lengkap" name="alamat" rows="3" required></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="no_hp">No. HP</label>
                    <input type="text" id="no_hp" class="form-control" placeholder="Masukkan Nomor HP" name="no_hp" required>
                  </div>
                  <div class="mb-3">
                    <label for="bkph">BKPH</label>
                    <input type="text" id="bkph" class="form-control" placeholder="Masukkan BKPH" name="bkph" required>
                  </div>
                  <div class="mb-3">
      ...
      <div class="table-responsive">
        <table id="example" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
            $no = 1;
            $query = mysqli_query($conn, "SELECT m.*, u.username, u.email 
                                          FROM mandor m 
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <div class="d-inline-flex gap-1">
                    <a href="#" class="btne btn-detail" data-bs-toggle="modal" data-bs-target="#detailmandor<?= $data['mandor_id'] ?>">
                      <iconify-icon icon="solar:eye-bold-duotone" height="20"></iconify-icon>
                    </a>
                      <?php if ($_SESSION['role'] == 'admin') { ?>
                    <a href="#" class="btne btn-edit fw-medium" data-bs-toggle="modal" data-bs-target="#editmandor<?= $data['mandor_id']; ?>">
                      <iconify-icon icon="solar:pen-2-bold-duotone" height="20"></iconify-icon>
                    </a>
                    <a href="../function/fungsi_mandor.php?aksi=hapus&mandor_id=<?= $data['mandor_id']; ?>&hapus=<?= $data['foto'] ?>" class="btne btn-hapus fw-medium">
              ...
              <!-- Modal Detail Mandor -->
              <div class="modal fade" id="detailmandor<?= $data['mandor_id'] ?>" tabindex="-1" aria-hidden="true">
                  ...
                  <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-header bg-primary text-white">
                      <h5 class="modal-title text-white fw-semibold">
                        <i class="bi bi-person-workspace me-2"></i>Detail Data Mandor
                      </h5>
                      <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                          ...
                          <div class="card-body">
                            <div class="row align-items-center">
                              ...
                              <div class="col-md-7">
                                ...
                                <div class="text-muted">Mandor BKPH <?= $data['bkph'] ?></div>
                                <span class="badge bg-<?= $data['status'] == 'aktif' ? 'success' : 'secondary' ?> mt-2 px-3 py-2">
                                  <?= ucfirst($data['status']); ?>
                                </span>
                              </div>
                    ...
                    <div class="modal-footer bg-white">
                      <a target="_blank"
                        href="../laporan/export_mandor.php?mandor_id=<?= $data['mandor_id'] ?>"
              ...
              <!-- Modal Edit -->
              <div class="modal fade" id="editmandor<?= $data['mandor_id']; ?>" tabindex="-1">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="../function/fungsi_mandor.php?aksi=edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <label for="status">Status</label>
                          <select name="status" class="selectinput" required>
