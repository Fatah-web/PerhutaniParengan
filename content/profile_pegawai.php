        ...
        <div class="card border-0 shadow-sm h-100 overflow-hidden">
            ...
            <div class="bg-primary bg-gradient text-white text-center p-4">
                ...
                <div class="position-relative d-inline-block mb-3">
                    ...
                    <img src="../image/<?= $data['foto']; ?>" alt="Foto Pegawai"
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="bg-dark bg-opacity-10 text-dark rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:hashtag-square-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="bg-info bg-opacity-10 text-info rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:card-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="bg-primary bg-opacity-10 text-primary rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:user-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="bg-danger bg-opacity-10 text-danger rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:letter-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="bg-success bg-opacity-10 text-success rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:phone-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="d-flex align-items-start">
                    ...
                    <div class="bg-warning bg-opacity-10 text-warning rounded-3 p-2 me-3">
                        ...
                        <iconify-icon icon="solar:map-point-bold-duotone" width="22">
                        </iconify-icon>
                ...
                <div class="text-center">
                    ...
                    <span class="badge <?= $badgeClass; ?> px-4 py-2 rounded-pill fw-semibold">
                        ...
                        <?= ucfirst($data['status'] ?? 'Belum Diatur'); ?>
    ...
    <div class="col-lg-8 align-self-start">
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Kelola informasi akun dan data profil pegawai
                        </p>

                    </div>

                    <a href="../laporan/export_pegawai.php?pegawai_id=<?= $data['pegawai_id'] ?>" target="_blank"
                        class="btn btn-success rounded-pill px-4">

                        <iconify-icon icon="solar:printer-bold-duotone" class="me-1" height="25" style="vertical-align: -0.5em;">
                        </iconify-icon>
                ...
                <!-- FORM -->
                <form class="row g-4" action="../function/fungsi_pegawai.php?aksi=updatepegawai" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-light" value="<?= ucfirst($data['role']); ?>"
                                disabled>
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editprofeil<?= $_SESSION['pegawai_id'] ?? '' ?>">
                             ...
                             <button type="submit" class="btn btn-primary px-4">
                                ...
                                <iconify-icon icon="solar:diskette-bold-duotone" class="me-1">
                                </iconify-icon>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4">
                ...
                <form action="../function/fungsi_users.php?aksi=updatePassword"
                    method="post">
    ...
    <div class="modal fade" id="editprofeil<?= $data['pegawai_id']; ?>" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="../function/fungsi_pegawai.php?aksi=editprofil" method="POST" enctype="multipart/form-data">
