...
// Ambil semua data BKPH + Mandor

$role      = $_SESSION['role'] ?? '';
$mandor_id = $_SESSION['mandor_id'] ?? '';

$sql = "
    SELECT b.*, m.nama AS nama_mandor
    FROM bkph b
...
<div class="kop">
    ...
    <div class="title">LAPORAN DATA BKPH</div>
    <div class="subtitle">Dokumen Resmi Data BKPH dan Perencanaan Tanam</div>
...
<tr>
    <th width="3%">No</th>
    <th width="10%">Nama BKPH</th>
    <th width="8%">RPH</th>
    <th width="6%">Petak</th>
    <th width="8%">Luas Baku (Ha)</th>
