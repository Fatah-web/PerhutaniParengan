...
<head>
<meta charset="UTF-8">
<title>Laporan Data Lubang</title>
<style>
    body { 
...
<div class="kop">
    ...
    <div class="title">LAPORAN DATA LUBANG</div>
    <div class="subtitle">Dokumen Resmi Monitoring Pembuatan Lubang</div>
    <div class="alamat">
...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    if (!empty($row['foto_lokasi'])) {
        $fotoPath = '../gambar_lubang/' . $row['foto_lokasi'];
    ...
    <tr>
        ...
        <td>' . htmlspecialchars($row['jumlah_lubang'] ?? '-') . ' Lubang</td>
