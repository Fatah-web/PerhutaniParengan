...
<head>
<meta charset="UTF-8">
<title>Laporan Data Penanaman</title>
<style>
    body { 
...
<div class="kop">
    ...
    <div class="subtitle">Dokumen Resmi Monitoring Penanaman Pohon</div>
    <div class="alamat">
...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    // Foto base64
    $fotoBase64 = '';
    if (!empty($row['foto_tanam'])) {
        $fotoPath = '../gambar_tanam/' . $row['foto_tanam'];
    ...
    $rencana = 
        ...
        'Target: ' . htmlspecialchars($row['target_pohon'] ?? '-') . ' Pohon<br>' .
    ...
    <tr>
        ...
        <td>' . htmlspecialchars($row['jumlah_tanam'] ?? '-') . ' Pohon</td>
