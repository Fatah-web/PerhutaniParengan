...
// AMBIL ID LUBANG
// =====================
$lubang_id = $_GET['lubang_id'] ?? 0;
if ($lubang_id == 0) {
    die("Data lubang tidak ditemukan.");
}
...
// FOTO LOKASI BASE64
// =====================
$fotoPath = '../gambar_lubang/' . $data['foto_lokasi'];
$fotoBase64 = '';

if (!empty($data['foto_lokasi']) && file_exists($fotoPath)) {
...
<html>
<head>
<title>Data Lubang - BKPH ' . htmlspecialchars($data['nama_bkph']) . '</title>
<style>
    body { 
...
<div class="kop">
    ...
    <div class="title">LAPORAN DATA LUBANG TANAM</div>
    <div class="alamat">
...
<div class="highlight-box">
    ...
    <span class="badge info">Target ' . number_format($data['target_pohon']?? 0) . ' Pohon</span>
    <span class="badge warning">' . number_format($data['jumlah_lubang']?? 0) . ' Lubang Dibuat</span>
...
$dompdf->stream(
    "lubang_" . $lubang_id . "_" . date('Ymd_His') . ".pdf",
    ["Attachment" => 0]
);
exit;
