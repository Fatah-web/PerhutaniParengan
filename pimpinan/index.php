...
if ($_SESSION['role'] == "" || $_SESSION['role'] !== "pimpinan") {
        ...
        <!-- Sidebar navigation-->
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a
                class="sidebar-link primary-hover-bg"
                href="./index.php?p=pemberitahuan"
                aria-expanded="false">
